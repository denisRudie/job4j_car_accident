...
<form action="<c:url value='/save'/>" method='POST'>
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="name" id="nameAccident"
    ...
    <div class="form-group">
        ...
        <input type="text" class="form-control" name="address" id="addressAccident"
               placeholder="Enter address" value="${accident.address}">
    </div>
